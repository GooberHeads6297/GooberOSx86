...
/* Like con_init_fb but does not bulk-clear or paint the 640x400 region.
 * Use on uncached firmware GOP (Braswell) where a full-frame memset wedges
 * the panel; cells appear incrementally via con_put_cell(). */
