...
# Compile kernel, drivers, filesystem, and shell
...
i686-elf-gcc -ffreestanding -m32 -O0 -I. -c fs/filesystem.c      -o ${BUILD_DIR}/filesystem.o
i686-elf-gcc -ffreestanding -m32 -O0 -I. -c shell/shell.c        -o ${BUILD_DIR}/shell.o
